...
export const savePreferences = () => {
    ...
    try {
        ...
        enabledTenses.subscribe(value => { tenseValues = value; })();
        enabledPolarities.subscribe(value => { polarityValues = value; })();
        enabledFormalities.subscribe(value => { formalityValues = value; })();
        useRomaji.subscribe(value => { romajiValue = value; })();
