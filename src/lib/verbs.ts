...
export const tenseOptions: ConjugationOption[] = [
    ...
    { id: 'conditionalBa', label: 'Conditional (Ba)', description: 'ば形' },
    { id: 'conditionalTara', label: 'Conditional (Tara)', description: 'たら形' },
    { id: 'progressive', label: 'Progressive', description: 'ている形' },
    { id: 'desire', label: 'Desire', description: 'たい形' },
    { id: 'causativePassive', label: 'Causative-Passive', description: '使役受身形' }
];
