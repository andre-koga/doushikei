						...
						<div class="space-y-3">
							...
							{#if currentTense === 'present'}
								<div>
									...
									<ul class="list-disc pl-5">
										<li>
											<span class="font-medium">Ichidan verbs:</span> Remove る and add ます (polite)
										</li>
										<li>
											<span class="font-medium">Godan verbs:</span> Change last kana to い-row + ます
											(polite)
										</li>
										<li>
											<span class="font-medium">Negative plain:</span> Change to あ-row + ない
										</li>
										<li>
											<span class="font-medium">Negative polite:</span> Change to い-row + ません
										</li>
									</ul>
								</div>
							{:else if currentTense === 'past'}
								<div>
									...
									<ul class="list-disc pl-5">
										<li>
											<span class="font-medium">Ichidan verbs:</span> Remove る and add た (plain) or
											ました (polite)
										</li>
										<li>
											<span class="font-medium">Godan verbs:</span> Change last kana according to consonant
											endings
										</li>
										<li>
											<span class="font-medium">Negative plain:</span> Change to あ-row + なかった
										</li>
										<li>
							...
							{:else if currentTense === 'teForm'}
								<div>
									...
									<ul class="list-disc pl-5">
										...
										<li>
											<span class="font-medium">Godan verbs ending in く:</span> Change to いて
										</li>
										<li>
											<span class="font-medium">Godan verbs ending in ぐ:</span> Change to いで
										</li>
										<li>
											<span class="font-medium">Godan verbs ending in す:</span> Change to して
										</li>
									</ul>
								</div>
							{:else if currentTense === 'potential'}
								<div>
									...
									<ul class="list-disc pl-5">
										<li>
											<span class="font-medium">Ichidan verbs:</span> Remove る and add られる
										</li>
										<li><span class="font-medium">Godan verbs:</span> Change to え-row + る</li>
										<li>
											<span class="font-medium">Negative:</span> Add ない to the potential form
										</li>
										<li>
											<span class="font-medium">Polite:</span> Add ます to the stem of the potential
											form
										</li>
									</ul>
								</div>
							{:else if currentTense === 'must'}
								<div>
									...
									<ul class="list-disc pl-5">
										<li>
											<span class="font-medium">Affirmative:</span> Negative conditional + ならない (plain)
											or なりません (polite)
										</li>
										<li>
											<span class="font-medium">Negative (don't have to):</span> Negative conditional
											+ なくてもいい (plain) or なくてもいいです (polite)
										</li>
										<li>
											Both forms なければならない and なければなりません are commonly used and
											accepted.
										</li>
									</ul>
									<p class="mt-2">
										Unlike English, Japanese forms the negative of "must" as "don't have to" rather
										than "must not".
									</p>
								</div>
							{:else}
								<div>
									...
									<p>
										This form is one of many Japanese verb conjugations. Practice regularly to
										master it along with other forms.
									</p>
								</div>
							{/if}
							...
							<p class="border-t border-gray-600 pt-2 text-sm text-gray-400">
								Remember: Regular practice with different verbs will help you master this
								conjugation pattern.
							</p>
						</div>
					</div>
